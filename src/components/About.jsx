...
const About = () => {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-3xl lg:text-6xl text-[#212529] tracking-tighter uppercase font-extrabold">
          About Us
        </h2>
        <h3 className="text-xl lg:text-3xl text-[#495057] font-bold leading-3 mb-4 lg:mb-8">
          Transformation through education
        </h3>
        <p className="text-md lg:text-lg text-semibold text-[#868e96]">
          ...
          classroom through online learning, Next Lesson empowers millions of
          learners to unlock their potential and become changemakers.
        </p>
      </div>
      <div>
        <h2 className="text-3xl text-[#495057] font-bold leading-6 mt-8 mb-2">
          Our mission
        </h2>
        <p className="text-md lg:text-lg text-semibold text-[#868e96]">
        ...
        <ul className="list-disc ml-8 text-md lg:text-lg font-semibold text-[#868e96] ">
          <li>
      ...
      <div>
        ...
        <p className="text-md lg:text-lg text-semibold text-[#868e96]">
          ...
          our partners, continually creating the future. In honor of our 10-year
          anniversary, we&#39;re taking a moment to acknowledge where we&#39;ve
          been, what we&#39;ve achieved and, in so doing, truly celebrate how
          far we&#39;ve come. &#39;
        </p>
      </div>
      <div>
