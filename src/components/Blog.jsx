...
const Blog = () => {
  ...
  return (
    <section
      className={`${dark ? 'text-[#e9ecef] bg-[#343a40]' : ''} py-12 my-[-2px]`}
    >
      <section
        style={{
        ...
        >
          {({ toPdf }) => (
            <Tooltip content="Download the file">
              <button
                className={`h-12 w-12 absolute right-[10%] top-[10%]  ${
                  dark
                    ? ' bg-[#495057] text-[#e9ecef] hover:bg-[#495057]'
        ...
        <div ref={ref} className="">
          <article className="w-[90%] lg:w-4/5 mx-auto text-md lg:text-xl py-6 md:py-8 leading-7 md:leading-6 lg:leading-8">
            ...
            <p className="ml-4 lg:ml-8">
              ...
              origins &#41;different in terms of protocol, hostname, or
              port&#41; other than its origin from which the unknown origin gets
              permission to access and load resources.
            </p>
            <p className="mt-3 ml-4 lg:ml-8">
          ...
          <article className="w-[90%] lg:w-4/5 mx-auto text-md lg:text-xl py-6 md:py-8 leading-7 md:leading-6 lg:leading-8">
            ...
            <p className="ml-4 lg:ml-8">
              ...
              throughout the entire app development lifecycle, including
              building, testing, releasing, monitoring, and engaging. Most of
              its functionality is free, causing many companies to use it
              without considering whether it's ideal for their use case.
              However, any platform as comprehensive as Firebase is bound to
              lack advanced features. This might not be a problem for mobile
              teams that don't have advanced needs. However, for companies that
              rely on mobile as a primary touch-point and revenue source, they
              will likely find themselves frustrated with Firebase limitations
              that prevent them from delivering optimized mobile experiences.
            </p>
            ...
            <ul className="list-disc ml-8 lg:ml-12">
              ...
              <li>
                Firebase Cloud Storage: used to store user-generated content
                like the profile picture, multimedia messages, etc.
              </li>
            ...
            <ul className="list-disc ml-8 lg:ml-12">
              <li>
                Firebase Remote Config: I love this product; it actually saved
                me sometimes from going broke. Here I&#39;ve already written
                enough about it why I love it since it allows you to modify the
                appearance and behavior of your app without letting users
                download your app.
              </li>
              <li>
                Firebase Cloud Storage: used to store user-generated content
            ...
            <p className="ml-4 lg:ml-8">
              Firebase is a complete BaaS platform operated by Google, and most
              of its features are free. Its core features are divided into three
              parts: Build, Release & Monitor, and Engage, making it a great
              solution for those that want a single platform for the entire
              development process. However, Firebase has some drawbacks that
              cause companies to look for other BaaS alternatives. Here are a
              few reasons why users might switch:
            </p>
            <ul className="list-disc ml-8 lg:ml-20">
              <li>
          ...
          <article className="w-[90%] lg:w-4/5 mx-auto text-md lg:text-xl py-6 md:py-8 leading-7 md:leading-6 lg:leading-8">
            ...
            <p className="ml-4 lg:ml-8">
              ...
              logged in the user is redirected to the /login page with the
              return url passed in the location state property. The current
              logged in user <code>&#40;authUser&#41;</code> is retrieved from
              Redux state with a call to the useSelector&#40;&#41; hook. Redux
              is used in this example however it is not required to implement a
              Private Route component in React Router 6. You could use a
              different state management library or any approach you prefer to
              get the logged in status of the user.
            </p>
            <p className="mt-3 ml-4 lg:ml-8">
              The <code> App</code> component is the root component of the
              example app, it contains the outer html, main nav and routes for
              the application. The <code>/login</code> route is public, and the
              home route &#40;/&#41; is protected by the private route component
              that uses Redux to check if the user is logged in. The last route
              is a catch-all redirect route that redirects any unmatched paths
              to the home page.
            </p>
          </article>
          <article className="w-[90%] lg:w-4/5 mx-auto text-md lg:text-xl py-6 md:py-8 leading-7 md:leading-6 lg:leading-8">
            ...
            <p className="mt-3 ml-4 lg:ml-8">
              ...
              is different from other run times, we need to understand how
              ...
              send a request, and the server processes each one before sending
              the response back. However, multiple threads are used to process
