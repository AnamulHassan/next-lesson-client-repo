...
const Home = () => {
  return (
    <section className="w-[90%] mx-auto my-12">
      <div>
        <h2 className="text-4xl lg:text-6xl font-bold text-[#343a40] xl:mt-12  tracking-tighter ">
          Start learning <br /> from the world&#44;s best institutions
        </h2>
        <p className="text-xl lg:text-2xl font-semibold leading-6 text-[#868e96] mt-2 mb-12">
      ...
      <div className="w-full flex flex-col lg:flex-row mt-0  lg:mt-8">
        <div className=" w-[90%] lg:w-2/4 px-4 lg:px-12 py-10 flex flex-col item-center lg:items-start justify-center bg-white lg:bg-[#f1f3f5]">
          <div>
            <h2 className=" text-[#343a40]  text-4xl font-bold">
              {' '}
              For Learners
            </h2>
            <h3 className="text-2xl text-[#868e96] font-semibold">
              Propel your career, get a degree, or expand your knowledge at any
              level.
            </h3>
          </div>
          <div>
            <h2 className=" text-[#343a40]  text-4xl font-bold mt-5">
              For Businesses
            </h2>
            <h3 className="text-2xl text-[#868e96] font-semibold">
      ...
      <div>
        <h2 className="text-5xl xl:text-8xl font-bold text-[#343a40] xl:mt-12  tracking-tighter ">
          Enabling transformation
        </h2>
        <p className="text-lg xl:text-4xl font-semibold leading-6 text-[#868e96] mt-2 mb-12">
          Your Next Lesson learning experience is grounded in cutting edge
          cognitive science. With more than two dozen distinct learning features
          to help you achieve your goals, our approach follows three key
          principles:
        </p>
        ...
        <div className="w-[90%] lg:w-3/4 mx-auto">
          <h2 className=" text-[#343a40]  text-4xl font-bold mt-2">Practice</h2>
          <h3 className="text-xl lg:text-2xl font-semibold leading-6 text-[#868e96] mt-2 mb-4">
            ...
            quizzes, open response assessments, virtual environments, and more.
          </h3>
        </div>
        <div className="w-[90%] lg:w-3/4 mx-auto">
          <h2 className=" text-[#343a40]  text-4xl font-bold mt-2">Apply</h2>
          <h3 className="text-xl lg:text-2xl font-semibold leading-6 text-[#868e96] mt-2 mb-4">
